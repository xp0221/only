...
class ChartLineAnalysi extends React.Component {
  constructor(props) {
    super(props);
    this.chart = null;
  ...
  initChart() {
    ...
    const resizeChart = function() {
      ...
      let ele = document.querySelector('.pie-echart');
      let height = ele ? ele.clientHeight : 0;
  ...
  render() {
    return <div id={this.chartId} className="pie-echart" />;
  }
}
export default injectIntl(ChartLineAnalysi);
